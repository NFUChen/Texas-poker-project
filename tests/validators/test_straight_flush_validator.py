...
class StraightFlushValidatorTest(unittest.TestCase):
    def test_determines_that_there_are_not_five_consecutive_cards_with_same_suit(self):
        '''
        This is the first edge case, which looks like 'Straight Flush'.
        Although it is a valid 'Straight', it is not a valid 'Straight Flush'
        '''
    ...
    def test_determines_that_there_are_five_consecutive_cards_with_same_suit(self):
        '''
        This is the second edge case, a valid 'Straight Flush'
        '''
        cards = [
            Card(rank="3", suit="Clubs"),
            Card(rank="4", suit="Clubs"),
    ...
    def test_determines_that_there_are_five_consecutive_cards_with_same_suit_(self):
        '''
        This is the second edge case, a valid 'Straight Flush'
        '''
